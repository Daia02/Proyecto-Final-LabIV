    ...
    <div class="row justify-content-center">
        <div class="col-6">
            <div class="d-flex flex-column align-items-start mb-2">
                <a href="${pageContext.request.contextPath}/ServletInfoUsuario">Volver atrás</a>
            </div>
            <div class="p-4 mb-3 bg-dark text-white rounded">
                ...
                <form method="post" action="${pageContext.request.contextPath}/ServletCambiarContra">
                    ...
                    <div class="btn-container">
                        ...
                        <a class="btn btn-secondary w-100 mt-2" href="${pageContext.request.contextPath}/ServletInfoUsuario">Cancelar</a>
                    </div>
                </form>
