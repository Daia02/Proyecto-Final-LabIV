        ...
        <div class="card-body">
            ...
            <form action="ServletTransferencias" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="cbuOrigen" name="cbuOrigen" required>
                        <option value="" disabled selected>Seleccione una cuenta</option>
                        <c:forEach var="cuenta" items="${sessionScope.cuentasDisponibles}">
                            <option value="${cuenta.cbu}">${cuenta.numeroCuenta} - ${cuenta.saldo} ARS</option>
                        </c:forEach>
                    </select>
                </div>
